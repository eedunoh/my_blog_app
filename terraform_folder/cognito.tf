...
resource "aws_cognito_user_pool" "my_user_pool" {
  ...
  verification_message_template {
    ...
    email_subject_by_link  = "Your blog app verification link"
  }
...
resource "aws_cognito_user_pool_domain" "my_domain" {
  domain       = "myapp-blog"                                     # The Cognito domain is needed for OAuth token exchange between the app and cognito. It works behind the scene.
  user_pool_id = aws_cognito_user_pool.my_user_pool.id
}
